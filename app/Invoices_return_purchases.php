<?php
  $page_title = 'All Invoices return purchases';
  require_once('../includes/load.php');
  // Checkin What level user has permission to view this page
  page_require_level(1);
  $all_inventory = find_all('inventory');
  $Invoices_return_purchases = find_all('Invoices');
?>
...
<?php
 if (isset($_POST['add_return'])) {
     ...
     for ($i=0;$i<$f;$i++) {
         ...
         $date= make_date();
		 $sale=(int)($_POST['sale price'][$i]);
         $sql  = "INSERT INTO return_purchase(`product_id`, `inv_id`, `supplier_id`, `data`)";
         $sql .= " VALUES ('{$p_id}','{$inv_id}','{$sup_id}','{$date}','{$sale}')";
		 $total_price=$sale;
         ...
         if ($db->query($sql)) {
             ...
             $session->msg("s", "Successfully Added return");
         } else {
  ...
  <div class="col-md-10">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-md-3">
          <form method="post" action="Invoices_return_purchases.php" class="clearfix">
                ...
                <div class="col-md-4">
                  <div class="container">
                    ...
                    <div class="table-repsonsive" style="width:69%;">
                      ...
                      <div align="center">
                        <input type="submit" name="add_return" class="btn btn-info" value="Insert" />
                      </div>
                    </div>
          </form>
        </div>
