              ...
              <div class="form-group">
			   ...
			   <div class="col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder=" Account Number"    maxlength="10">
               </div>
              </div>
			   ...
			   <div class="col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder="Account name "  maxlength="10">
               </div>
              </div>
...
<!-- /add morre details -->
              <div class="form-group">
               <div class="row"  style="padding-left:28px;">
				 ...
				 <div class="col-md-3">
                  ...
                  <input type="text" class="datepicker form-control" name="end-date" placeholder="Date of supply">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder="Supplier number">
               </div>
              </div>
			  ...
			  <div class="col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder=" Customer Number"  maxlength="10">
               </div>
              </div>
			  ...
			  <div class="col-md-3" >
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" placeholder="Cost Center "  maxlength="10">
               </div>
              </div>
