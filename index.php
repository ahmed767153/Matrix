...
<html>
	<head>
		<title>Matrix Subscription</title>
		<link href="libs/css/sub_style.css" rel="stylesheet" type="text/css" media="all"/>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		<link href="https://fonts.googleapis.com/css?family=Monda" rel="stylesheet">

		<script src="libs/js/jquery-1.11.0.min.js"></script>
		<script src="libs/js/jquery.magnific-popup.js" type="text/javascript"></script>
		<script src="libs/js/jquery.validate.min.js" type="text/javascript"></script>
		<script>
	...
	<body>
		...
		<div class="priceing-table w3l">
			...
			<center> <img src="img/logo3.png" alt="Matrix-Inv" style="width:180px;height:60px;"> </center>
				<h1> Please select your package</h1>
        <!--h2>or login below to start your free trial</h2-->
	...
	<p>Have an Account please <a href="login.php" hover="red" target="_top">Login </a>  </p>
    <p>To start your free Trial  please click   <a href="login.php" target="_parent">here </a>  </p>
    </div>
		<div class="copy-rights">
